...
//#define EMULATE_STT 1
//#define EMULATE_PCM 1
//#define CLFLUSH_CPU 1
//#define CLWB_CPU 1
...
#ifdef EMULATE_STT
#define asm_clflush(addr) emulate_latency_ns(140)
#define asm_mfence()      { emulate_latency_ns(200); __asm__ __volatile__ ("mfence"); }
#define asm_sfence()      emulate_latency_ns(200)
#elif EMULATE_PCM
#define asm_clflush(addr) emulate_latency_ns(340)
#define asm_mfence()      { emulate_latency_ns(500); __asm__ __volatile__ ("mfence"); }
#define asm_sfence()      emulate_latency_ns(500)
#elif CLFLUSH_CPU
#define asm_clflush(addr) asm volatile("clflush (%0)" :: "r" (addr) : "memory")
#define asm_mfence()      __asm__ __volatile__ ("mfence")
#define asm_sfence()      {}
#elif CLWB_CPU
#define asm_clflush(addr) asm volatile(".byte 0x66; xsaveopt %0" : "+m" (*(volatile char *)(addr)))
#define asm_mfence()      __asm__ __volatile__ ("mfence")
#define asm_sfence()      __asm__ __volatile__ ("sfence")
#else
#define asm_clflush(addr) asm volatile(".byte 0x66; clflush %0" : "+m" (*(volatile char *)(addr)))
#define asm_mfence()      __asm__ __volatile__ ("mfence")
#define asm_sfence()      __asm__ __volatile__ ("sfence")
#endif
