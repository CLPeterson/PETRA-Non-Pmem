...
cmap_file = input("enter path to processed cmap data")
petra_file = input("enter path to processed petra data")
num_groups = 2
bar_width = 0.1
opacity = 0.8
...
with open(cmap_file, "r") as cfile, open(petra_file, "r") as dfile:
...
plt.title(benchmark)
plt.tight_layout()
plt.xticks(index + (bar_width * 7 / 2), ("cmap", "PETRA"))

plt.savefig(input("Output file name"), dpi=600)
